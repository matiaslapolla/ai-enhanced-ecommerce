...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  const handleRoleChange = (value: "admin" | "seller" | "customer") => {
    const credentials = {
      admin: { email: "admin@demo.com", password: "admin123" },
      seller: { email: "seller@demo.com", password: "seller123" },
      customer: { email: "buyer@demo.com", password: "buyer123" },
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onClose()
      setFormData({ email: "", password: "", name: "", confirmPassword: "", role: "customer" })
    } catch (error) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Button variant="outline" className="w-full bg-transparent" onClick={() => handleOAuthLogin("Facebook")}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Credentials will be auto-filled for demo purposes</p>
            </div>
